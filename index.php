...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+250 (79)050-83-98</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUN <span>RISE</span><p class="logo_w3l_agile_caption">Your Dreamy fresh Air</p></a></h1>
				</div>
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Please welcome and enjoy vaccation with us. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div id="horizontalTab">
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Ivan Simpson</h4>
							<span>Manager</span>
							<p>His the Manager of sunrise hotel since 2015, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.Lorem ipsum dolor .</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+250 (79)050-83-98</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong>Kanombe Airport Road, kicukiro, Kigali-Rwanda</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 SUNRISE . All Rights Reserved | Design by <a href="index.php">SUNRISE<b style="color: green; font-family: Roman"> MR A</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
