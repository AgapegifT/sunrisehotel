                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-body'>
                                            ...
                                            <input name='usname' value='<?php echo $crow['fname']; ?>' class='form-control' placeholder='Enter User name'>
											</div>
										</div>
										<div class='modal-body'>
                                            <div class='form-group'>
                                            <label>Change Password</label>
                                            <input name='pasd' value='<?php echo $crow['ps']; ?>' class='form-control' placeholder='Enter Password'>
											</div>
                                        </div>
